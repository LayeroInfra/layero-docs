...
:::note
GitHub — один из пяти провайдеров. GitVerse, GitLab, GitFlic и SourceCraft
подключаются токеном; отличия и таблица возможностей — на странице
[Подключение репозитория](./git-providers.md).
:::
